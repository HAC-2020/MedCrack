...
@Metadata(
        ...
        d2 = {"Lcom/example/test/medcrack/ReminderApp;", "Landroid/app/Application;", "()V", "repository", "Lcom/example/test/medcrack/ReminderRepository;", "getRepository", "onCreate", "", "app_debug"}
)
